# 프롬프트 017: Construction - Unit 5 구현
...
당신의 과제: 논리적 설계 세부사항은 aidlc-docs/construction/unit-05-quality-metrics/logical_design.md 파일을 참조하세요.

구현 코드/문서를 aidlc-docs/construction/unit-05-quality-metrics/src/ 디렉터리에 생성하세요.
```
